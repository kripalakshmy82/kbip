...
function add_more(baseurl)
{
  ...
  strinner="<div class='row'> <div class='col-md-3'><div class='form-group'><input type='text' id='imgcaption"+numrows+"' name='imgcaption"+numrows+"'  class='form-control' placeholder='Image Caption'/></div> </div><div class='col-md-3'><div class='form-group'><input type='file' id='document"+numrows+"' name='document"+numrows+"' onchange='loadImage("+numrows+")' accept='.jpg, .jepg' /><span class='label label-default'>Format:.jpg, .jepg, .JPG, .JEPG</span><img src='"+baseurl+"images/close3.png' title='Click to remove File'  id='clear_multiple"+numrows+"' height='20px'  style='cursor:pointer' onclick='remove("+numrows+")'/></div></div><div class='col-md-3'><div class='form-group'><input type='file' id='custom_document"+numrows+"' name='custom_document"+numrows+"' onchange='loadImageCustom("+numrows+")' accept='.jpg, .jepg' /><span class='label label-default'>Format:.jpg, .jepg, .JPG, .JEPG</span><img src='"+baseurl+"images/close3.png' title='Click to remove File'  id='clear_multiple"+numrows+"' height='20px'  style='cursor:pointer' onclick='remove("+numrows+")'/></div></div><div class='col-md-3'><div class='form-group'><textarea id='imgcaption"+numrows+"' name='imgcaption"+numrows+"'  class='form-control' placeholder='Image Description'/></textarea></div> </div></div>";
