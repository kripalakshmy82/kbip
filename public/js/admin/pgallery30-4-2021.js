			  ...
			  if((document.getElementById('imgcaption'+i).value !="" || document.getElementById('document'+i).value !='' ) && error==false )
				{
					...
					if(document.getElementById('custom_document'+i).value !="" && error==false)
					{
						var filereturn=FileExtension_Validate(document.getElementById('custom_document'+i).value);
						if (filereturn ==false)
						   {
							error=true;
							loadErrorModal('Please select a file with jpeg,jpg,JPEG,JPG extension','custom_document'+i);					
							document.getElementById('custom_document'+i).focus();
							return false;
						   } 
					}
...
function validate_pic(form,baseUrl,fun,pid)
{
	...
	if(fun=='add')
	{
		if((document.getElementById('document1').value =='' &&  document.getElementById('custom_document1').value =='' ) && error==false)
		{
			error=true;
	...
	if(fun=='update')
	{
		if((document.getElementById('document1').value =='' &&  document.getElementById('custom_document1').value ==''  && document.getElementById('olddocument1').value =='') && error==false)
		{
			error=true;
			loadErrorModal('Please choose the file','document1');
			document.getElementById('document1').focus();	
...
function add_more(baseurl, h, w, ch, cw,f,cf)
{
  ...
  strinner="<div class='row'> <div class='col-md-3'><div class='form-group'><input type='text' onkeyup='txtValidateName(this.id)' onkeypress='txtValidateName(this.id)' maxlength='200'  id='imgcaption"+numrows+"' name='imgcaption"+numrows+"'  class='form-control' placeholder='Image Caption'/></div> </div><div class='col-md-3'><div class='form-group'><input type='text' maxlength='200'  id='imgcaptionmal"+numrows+"' name='imgcaptionmal"+numrows+"'  class='form-control' placeholder='Image Caption (Malayalam)'/></div> </div><div class='col-md-3'><div class='form-group'><input type='file' id='document"+numrows+"' name='document"+numrows+"' onchange='loadImage("+numrows+", "+h+", "+w+")' accept='.jpg, .jepg' /><span class='label label-default'>Format:"+f+"</span></div></div><div class='col-md-3' style='display: none'><div class='form-group'><input type='file' id='custom_document"+numrows+"' name='custom_document"+numrows+"' onchange='loadImageCustom("+numrows+", "+ch+", "+cw+")' accept='.jpg, .jepg' /><span class='label label-default'>Format:"+cf+"</span></div></div><div class='col-md-3'><div class='form-group'><textarea id='img_desc"+numrows+"' name='img_desc"+numrows+"' onkeyup='txtValidateName(this.id)' onkeypress='txtValidateName(this.id)' maxlength='3000'  class='form-control' placeholder='Image Description'/></textarea></div> </div></div>";
  ...
  function add_more_pic(baseurl,h, w,ch, cw, f,cf)
{
  ...
  strinner="<div class='row'><div class='col-md-3'><div class='form-group'><input type='text' onkeyup='txtValidateName(this.id)' onkeypress='txtValidateName(this.id)' maxlength='200'  id='imgcaption"+numrows+"' name='imgcaption"+numrows+"'  class='form-control' placeholder='Image Caption'/></div></div><div class='col-md-3'><div class='form-group'><input type='text' maxlength='200'  id='imgcaptionmal"+numrows+"' name='imgcaptionmal"+numrows+"'  class='form-control' placeholder='Image Caption (Malayalam)'/></div> </div><div class='col-md-3'><div class='form-group'><input type='file' id='document"+numrows+"' name='document"+numrows+"' onchange='loadImage("+numrows+", "+h+", "+w+")'  /><span class='label label-default'>Format:"+f+"</span></div></div><div class='col-md-3' style='display: none'><div class='form-group'><input type='file' id='custom_document"+numrows+"' name='custom_document"+numrows+"' onchange='loadImage("+numrows+", "+ch+", "+cw+")'  /><span class='label label-default'>Format:."+cf+"</span></div></div><div class='col-md-3'><div class='form-group'><textarea id='img_desc"+numrows+"'  name='img_desc"+numrows+"' onkeyup='txtValidateName(this.id)' onkeypress='txtValidateName(this.id)' maxlength='3000'  class='form-control' placeholder='Image Description'> </textarea></div></div></div>";
